package com.example.color_agent_server.controller.advice;
...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleAllException(Exception ex, WebRequest request) {
        return super.handleExceptionInternal(ex, "handleAllException"+ex.getMessage(), null, HttpStatus.INTERNAL_SERVER_ERROR, request);
    }
